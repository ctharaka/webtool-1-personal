...
export const TOOLS_REGISTRY: Record<string, ToolMetadata> = {
  ...
  'pdf-organize': {
    ...
    category: 'pdf',
    description: 'Reorder, rotate, and delete pages from PDF documents with instant visual previews.',
    oneLiner: 'Reorder, rotate, and delete pages from PDF files visually.',
    icon: '📑',
    inputFormats: ['pdf'],
    outputFormats: ['pdf'],
    route: '/pdf/organize/',
    popular: true,
    featured: true,
    relatedSlugs: ['pdf-merge', 'pdf-split', 'pdf-sign', 'pdf-page-numbers'],
    seoTitle: 'Organize PDF Pages Online — Rotate, Reorder & Delete Pages Free',
    seoDescription: 'Organize PDF pages online for free. Reorder, rotate, and delete pages 100% locally in your browser.',
  },
  'pdf-sign': {
    slug: 'pdf-sign',
    ...
    shortName: 'Sign PDF',
    category: 'pdf',
    description: 'Draw or type your signature and place it onto any page of a PDF document.',
    oneLiner: 'Draw or type signatures to sign PDF documents online.',
    icon: '✍️',
    inputFormats: ['pdf'],
    outputFormats: ['pdf'],
    route: '/pdf/sign/',
    popular: true,
    featured: true,
    relatedSlugs: ['pdf-organize', 'pdf-watermark', 'pdf-merge', 'pdf-page-numbers'],
    seoTitle: 'Sign PDF Online Free — Draw or Type Signature on PDF',
    seoDescription: 'Sign PDF files online for free. Draw or type signatures and stamp date fields with 100% privacy.',
  },
  'pdf-page-numbers': {
    ...
    category: 'pdf',
    description: 'Add custom page numbers to all pages of a PDF document.',
    oneLiner: 'Add page numbers with custom position, format, and font size.',
    icon: '🔢',
    inputFormats: ['pdf'],
    outputFormats: ['pdf'],
    route: '/pdf/page-numbers/',
    popular: false,
    relatedSlugs: ['pdf-watermark', 'pdf-organize', 'pdf-merge'],
    seoTitle: 'Add Page Numbers to PDF Online — Free & Custom Page Numbering',
    seoDescription: 'Add page numbers to PDF documents online. Position page numbers at bottom center or top right with zero file uploads.',
  },
  'pdf-watermark': {
    slug: 'pdf-watermark',
    ...
    category: 'pdf',
    description: 'Add text watermarks to PDF documents with custom opacity, rotation, and font size.',
    oneLiner: 'Add custom text watermarks to PDF pages for privacy and protection.',
    icon: '💧',
    inputFormats: ['pdf'],
    outputFormats: ['pdf'],
    route: '/pdf/watermark/',
    popular: false,
    relatedSlugs: ['pdf-page-numbers', 'pdf-sign', 'pdf-organize'],
    seoTitle: 'Add Watermark to PDF Online — Free & Custom Text Watermarking',
    seoDescription: 'Watermark PDF documents online for free. Add custom text watermarks with opacity and angle controls.',
  },
  'pdf-to-text': {
    slug: 'pdf-to-text',
    ...
    shortName: 'PDF → Text',
    category: 'pdf',
    description: 'Extract embedded text from PDF pages into plain text or text files.',
    oneLiner: 'Extract plain text from PDF pages page-by-page.',
    icon: '📄',
    inputFormats: ['pdf'],
    outputFormats: ['txt'],
    route: '/pdf/to-text/',
    popular: true,
    relatedSlugs: ['text-to-pdf', 'pdf-to-jpg', 'pdf-split'],
    seoTitle: 'PDF to Text Converter — Extract Text from PDF Online',
    seoDescription: 'Extract text layer from PDF files in your browser. Copy text or download .txt file with full privacy.',
  },
  'text-to-pdf': {
    slug: 'text-to-pdf',
    ...
    shortName: 'Text → PDF',
    category: 'text',
    description: 'Convert plain text or Markdown to formatted multi-page PDF documents.',
    oneLiner: 'Convert plain text or Markdown into a clean PDF document.',
    icon: '📝',
    inputFormats: ['txt', 'md'],
    outputFormats: ['pdf'],
    route: '/text-to-pdf/',
    popular: true,
    relatedSlugs: ['pdf-to-text', 'jpg-to-pdf', 'png-to-pdf'],
    seoTitle: 'Text to PDF Converter — Convert Plain Text & Markdown to PDF Online',
    seoDescription: 'Convert plain text and Markdown into PDF documents in your browser. Custom page sizes and margins.',
  },
  ...
  'optimize-file': {
    ...
    route: '/optimize-file/',
    popular: true,
    relatedSlugs: ['image-optimizer', 'file-inspector', 'compress-image', 'heic-to-jpg'],
  ...
  'heic-to-jpg': {
    ...
    category: 'image',
    description: 'Convert Apple iPhone HEIC/HEIF photos to JPG or PNG format with quality control.',
    oneLiner: 'Convert iPhone HEIC photos to JPG or PNG locally.',
    icon: '📱',
    ...
    popular: true,
    featured: true,
    relatedSlugs: ['image-converter', 'compress-image', 'png-to-jpg', 'image-crop-rotate'],
    seoTitle: 'HEIC to JPG Converter — Convert iPhone HEIC Photos Free',
    seoDescription: 'Convert Apple iPhone HEIC/HEIF photos to standard JPG or PNG format 100% locally in your browser. Fast batch conversion with zero uploads.',
  },
  'mp4-to-mp3': {
    slug: 'mp4-to-mp3',
    ...
    category: 'audio',
    description: 'Extract audio tracks from MP4 video files into MP3 format with custom bitrate selection.',
    oneLiner: 'Extract audio from MP4 video files to MP3 locally.',
    icon: '🎬',
    ...
    popular: true,
    featured: true,
    relatedSlugs: ['audio-converter', 'audio-trimmer', 'compress-audio', 'wav-to-mp3'],
    seoTitle: 'MP4 to MP3 Converter — Extract Audio from Video Free',
    seoDescription: 'Extract audio tracks from MP4 video files and convert to MP3 format 100% locally in your browser with custom bitrates.',
  },
  'zip-creator': {
    slug: 'zip-creator',
    name: 'ZIP Creator & Archiver',
    shortName: 'ZIP Creator',
    category: 'developer',
    description: 'Package and compress multiple files into a single .zip archive locally.',
    oneLiner: 'Package files into a compressed .zip archive in your browser.',
    icon: '📦',
    inputFormats: ['any'],
    outputFormats: ['zip'],
    route: '/zip-creator/',
    popular: true,
    featured: true,
    relatedSlugs: ['zip-extractor', 'json-formatter', 'base64-encoder-decoder'],
    seoTitle: 'ZIP Creator — Compress Files into ZIP Archives Free',
    seoDescription: 'Package and compress multiple files into a single .zip archive 100% locally in your browser. Fast, secure, and private archiving.',
  },
  'zip-extractor': {
    slug: 'zip-extractor',
    name: 'ZIP Extractor & Unzipper',
    shortName: 'ZIP Extractor',
    category: 'developer',
    description: 'Unzip and extract files from .zip archives locally in your browser tab.',
    oneLiner: 'Inspect and extract files from .zip archives in local memory.',
    icon: '📂',
    inputFormats: ['zip'],
    outputFormats: ['any'],
    route: '/zip-extractor/',
    popular: true,
    relatedSlugs: ['zip-creator', 'file-inspector', 'hash-generator'],
    seoTitle: 'ZIP Extractor — Unzip Files Online Free',
    seoDescription: 'Unzip and extract files from .zip archives 100% locally in your browser. View file contents, preview images, and download individual files.',
  },
  'social-image-resizer': {
    slug: 'social-image-resizer',
    name: 'Social Media Image Resizer',
    shortName: 'Social Resizer',
    category: 'image',
    description: 'Resize and crop images for Instagram, YouTube, LinkedIn, and WhatsApp using exact presets.',
    oneLiner: 'Resize images with Instagram, YouTube, and LinkedIn presets.',
    icon: '📐',
    inputFormats: ['jpg', 'png', 'webp', 'avif'],
    outputFormats: ['jpg', 'png', 'webp'],
    route: '/social-image-resizer/',
    popular: true,
    featured: true,
    relatedSlugs: ['image-crop-rotate', 'compress-image', 'image-optimizer', 'favicon-generator'],
    seoTitle: 'Social Media Image Resizer — Instagram, YouTube, LinkedIn Presets',
    seoDescription: 'Resize and crop images for Instagram, YouTube, LinkedIn, and WhatsApp using exact pixel presets and aspect ratio controls 100% locally.',
  },
  'favicon-generator': {
    ...
    category: 'image',
    description: 'Generate website favicons in PNG sizes plus multi-resolution .ico files bundled in ZIP.',
    oneLiner: 'Generate .ico and PNG favicons for websites and PWAs.',
    icon: '✨',
    inputFormats: ['png', 'jpg', 'svg', 'webp'],
    outputFormats: ['ico', 'png', 'zip'],
    route: '/favicon-generator/',
    popular: true,
    featured: true,
    relatedSlugs: ['svg-to-png', 'social-image-resizer', 'zip-creator', 'png-to-jpg'],
    seoTitle: 'Favicon Generator — Create .ICO & PNG Icons Free',
    seoDescription: 'Generate favicons for websites and PWAs in all standard PNG sizes plus multi-resolution .ico files 100% locally in your browser.',
  },
  'image-crop-rotate': {
    slug: 'image-crop-rotate',
    name: 'Image Crop & Rotate Tool',
    shortName: 'Crop & Rotate',
    category: 'image',
    description: 'Rotate photos 90/180/270 degrees, flip horizontal/vertical, and crop custom image bounds.',
    oneLiner: 'Rotate, flip, and crop images with real-time canvas preview.',
    icon: '✂️',
    inputFormats: ['jpg', 'png', 'webp', 'avif'],
    outputFormats: ['jpg', 'png', 'webp'],
    route: '/image-crop-rotate/',
    popular: true,
    relatedSlugs: ['social-image-resizer', 'compress-image', 'png-to-jpg', 'jpg-to-png'],
    seoTitle: 'Image Crop & Rotate — Free Online Image Editor',
    seoDescription: 'Rotate photos 90/180/270 degrees, flip horizontally or vertically, and crop custom image regions 100% locally in your browser.',
  },
  'svg-to-png': {
    slug: 'svg-to-png',
    ...
    category: 'image',
    description: 'Convert Scalable Vector Graphics (SVG) into high-resolution PNG or JPG images.',
    oneLiner: 'Rasterize SVG vector documents into high-res PNG images.',
    icon: '🎨',
    inputFormats: ['svg'],
    ...
    popular: true,
    featured: true,
    relatedSlugs: ['favicon-generator', 'png-to-jpg', 'image-converter'],
    seoTitle: 'SVG to PNG Converter — Convert Vector SVG to High-Res PNG Free',
    seoDescription: 'Convert Scalable Vector Graphics (SVG) into high-resolution PNG or JPG images 100% locally in your browser with custom scale factors.',
  },
  'compress-image-to-100kb': {
    slug: 'compress-image-to-100kb',
    name: 'Compress Image to 100KB',
    shortName: '100KB Compressor',
    category: 'image',
    description: 'Reduce JPG, PNG, or WebP image size to under 100 KB for application forms and official uploads.',
    oneLiner: 'Automatically shrink images to under 100 KB using binary search compression.',
    icon: '📉',
    inputFormats: ['jpg', 'jpeg', 'png', 'webp'],
    outputFormats: ['jpg'],
    ...
    popular: true,
    featured: true,
    relatedSlugs: ['compress-image', 'compress-image-to-50kb', 'compress-image-to-200kb', 'image-converter'],
    seoTitle: 'Compress Image to 100KB Online Free — Reduce JPG & PNG Size',
    seoDescription: 'Compress images to under 100 KB online. Automatic binary search quality tuning for online form uploads with 100% privacy.',
  },
  'compress-image-to-50kb': {
    slug: 'compress-image-to-50kb',
    name: 'Compress Image to 50KB',
    shortName: '50KB Compressor',
    category: 'image',
    description: 'Reduce JPG, PNG, or WebP image size to under 50 KB for strict online portal uploads.',
    oneLiner: 'Automatically shrink images to under 50 KB for application forms.',
    icon: '📉',
    inputFormats: ['jpg', 'jpeg', 'png', 'webp'],
    outputFormats: ['jpg'],
    route: '/compress-image-to-50kb/',
    popular: true,
    relatedSlugs: ['compress-image', 'compress-image-to-100kb', 'compress-image-to-200kb'],
    seoTitle: 'Compress Image to 50KB Online Free — Reduce Photo Size',
    seoDescription: 'Compress images to under 50 KB online for free. Automatic binary search compression for strict online portal uploads with 100% privacy.',
  },
  'compress-image-to-200kb': {
    slug: 'compress-image-to-200kb',
    name: 'Compress Image to 200KB',
    shortName: '200KB Compressor',
    category: 'image',
    description: 'Reduce JPG, PNG, or WebP image size to under 200 KB for registration portals and forms.',
    oneLiner: 'Automatically shrink images to under 200 KB using binary search compression.',
    icon: '📉',
    inputFormats: ['jpg', 'jpeg', 'png', 'webp'],
    outputFormats: ['jpg'],
    route: '/compress-image-to-200kb/',
    popular: true,
    relatedSlugs: ['compress-image', 'compress-image-to-100kb', 'compress-image-to-50kb'],
    seoTitle: 'Compress Image to 200KB Online Free — Reduce JPG & PNG Size',
    seoDescription: 'Compress images to under 200 KB online for free. Automatic binary search compression for online forms and portals.',
  },
  'heic-to-png': {
    slug: 'heic-to-png',
    ...
    category: 'image',
    description: 'Convert Apple iPhone HEIC/HEIF photos to lossless PNG format 100% locally.',
    oneLiner: 'Convert iPhone HEIC photos to lossless PNG format in browser.',
    icon: '📱',
    inputFormats: ['heic', 'heif'],
    outputFormats: ['png'],
    route: '/heic-to-png/',
    popular: true,
    relatedSlugs: ['heic-to-jpg', 'png-to-jpg', 'image-converter'],
    seoTitle: 'HEIC to PNG Converter — Convert iPhone Photos to PNG Free',
    seoDescription: 'Convert Apple iPhone HEIC/HEIF photos to lossless PNG format 100% locally in your browser. Fast batch conversion.',
  },
  'pdf-rotate': {
    slug: 'pdf-rotate',
    ...
    category: 'pdf',
    description: 'Rotate PDF pages clockwise or counter-clockwise 90, 180, or 270 degrees locally.',
    oneLiner: 'Rotate upside-down PDF pages or landscape pages 100% locally.',
    icon: '🔄',
    inputFormats: ['pdf'],
    outputFormats: ['pdf'],
    route: '/pdf/rotate/',
    popular: true,
    relatedSlugs: ['pdf-organize', 'pdf-delete-pages', 'pdf-reorder-pages', 'pdf-merge'],
    seoTitle: 'Rotate PDF Pages Online Free — Turn PDF Clockwise or Counter-Clockwise',
    seoDescription: 'Rotate PDF pages online for free. Orient upside-down scans or landscape pages 100% locally in your browser.',
  },
  'pdf-delete-pages': {
    ...
    category: 'pdf',
    description: 'Remove unwanted pages or blank sheets from PDF documents 100% locally.',
    oneLiner: 'Remove unwanted pages from PDF files with zero server uploads.',
    icon: '🗑️',
    inputFormats: ['pdf'],
    outputFormats: ['pdf'],
    route: '/pdf/delete-pages/',
    popular: true,
    relatedSlugs: ['pdf-organize', 'pdf-rotate', 'pdf-reorder-pages', 'pdf-split'],
    seoTitle: 'Delete PDF Pages Online Free — Remove Unwanted Pages from PDF',
    seoDescription: 'Delete unwanted pages from PDF files online for free. Remove blank pages or cover sheets 100% locally.',
  },
  'pdf-reorder-pages': {
    ...
    category: 'pdf',
    description: 'Rearrange and reorder page sequence in multi-page PDF documents locally.',
    oneLiner: 'Rearrange page order in PDF documents with visual controls.',
    icon: '🔀',
    inputFormats: ['pdf'],
    outputFormats: ['pdf'],
    route: '/pdf/reorder-pages/',
    popular: true,
    relatedSlugs: ['pdf-organize', 'pdf-rotate', 'pdf-delete-pages', 'pdf-merge'],
    seoTitle: 'Reorder PDF Pages Online Free — Rearrange PDF Page Order',
    seoDescription: 'Reorder PDF pages online for free. Rearrange page sequence and save updated PDF 100% locally.',
  },
};
