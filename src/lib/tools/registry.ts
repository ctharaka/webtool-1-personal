...
export const TOOLS_REGISTRY: Record<string, ToolMetadata> = {
  ...
  'png-to-jpg': {
    ...
    category: 'image',
    description: 'Batch convert PNG images to standard JPEG format with quality controls and background fill.',
    oneLiner: 'Convert PNG graphics to JPEG with custom background fill.',
    icon: '🖼️',
    inputFormats: ['png'],
    outputFormats: ['jpg'],
    route: '/png-to-jpg',
    popular: true,
    relatedSlugs: ['jpg-to-png', 'compress-image', 'heic-to-jpg', 'image-converter'],
    seoTitle: 'PNG to JPG Converter — Convert PNG to JPEG Online Free',
    seoDescription: 'Convert PNG images to standard JPEG format 100% locally in your browser. Batch conversion, custom quality slider, and background fill options.',
  },
  'jpg-to-png': {
    slug: 'jpg-to-png',
    name: 'JPG to PNG Converter',
    ...
    category: 'image',
    description: 'Convert JPG and JPEG photos to lossless PNG format locally in your browser.',
    oneLiner: 'Convert JPEG photos to lossless PNG format.',
    icon: '🖼️',
    inputFormats: ['jpg', 'jpeg'],
    outputFormats: ['png'],
    route: '/jpg-to-png',
    popular: true,
    relatedSlugs: ['png-to-jpg', 'heic-to-jpg', 'image-converter', 'compress-image'],
    seoTitle: 'JPG to PNG Converter — Convert JPEG to PNG Online Free',
    seoDescription: 'Convert JPG and JPEG photos to lossless PNG format 100% locally in your browser with fast batch processing and zero server uploads.',
  },
};
