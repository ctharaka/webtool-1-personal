 ...
 * Supports both UTF-8 strings and ArrayBuffer inputs.
...
/**
 * Computes the MD5 hex digest of a string or ArrayBuffer/Uint8Array.
...
export function md5(input) {
  ...
  if (typeof input === 'string') {
    ...
    throw new TypeError('Input must be string, ArrayBuffer, or Uint8Array');
  }
